...
class JupyterUI:
    ...
    def display_buttons(self):
        display(widgets.VBox([self.b_pipeline,
                              ...
                              widgets.HBox([self.b_filter, self.b_power_line]),
                              self.b_accordion_filter,
                              widgets.HBox([self.b_detect, self.b_channel_detect, self.b_threshold]),
                              widgets.HBox([self.b_stimulate, self.b_sound_detect, self.b_volume, self.b_test_stimulus]),
                              self.b_accordion_delaying,
                              widgets.HBox([self.b_lsl, self.b_display]),
                              widgets.HBox([self.b_record, self.b_filename, self.b_record_raw, self.b_record_filtered]),
