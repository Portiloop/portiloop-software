...
class JupyterUI:
    def __init__(self, pipelines=PIPELINES, default_pipeline_key=DEFAULT_PIPELINE_KEY):
        ...
        self.vref = 4.5  # FIXME: this value is a temporary fix for what seems to be a hardware bug
    ...
    def display_buttons(self):
        display(widgets.VBox([self.b_pipeline,
                              ...
                              self.b_stimulate,
                              widgets.HBox([self.b_sound_detect, self.b_volume, self.b_test_stimulus]),
    ...
    def run_test_stimulus(self):
        if self.stimulator_cls is not None:
